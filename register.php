...
<style>
    ...
    body {
        ...
        margin: 18px;
        background-color:rgb(14, 229, 222);
        color: #333;
    }
...
<div class="home">
    ...
    if(!empty($_POST['register'] )){
        ...
        $sql2="select * from pt where email='$mail'";
        $result=mysqli_query($conn,$sql2);
        if(mysqli_num_rows($result)>0){
            echo "<p style='text-align:center;color:red; font-weight:700;'>User already exists!</p>";
        }
        else{
            $sql="insert into pt(name,age,bloodgroup,phone,email,address) values('$name',$age,'$bloodgroup',$mob,'$mail','$address')";
            try{
    ...
    include 'conn.php';
        ...
        $query="select id,name,phone,address,email,amount from pt";
